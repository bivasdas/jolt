...
public class Math {
    ...
    public static final class max extends Function.ListFunction<Number> {
        @Override
    ...
    @SuppressWarnings( "unchecked" )
    public static final class min extends Function.ListFunction<Number> {
        @Override
    ...
    @SuppressWarnings( "unchecked" )
    public static final class avg extends Function.ListFunction<Double> {
        @Override
        protected Optional<Object> applyList( final List<Object> argList ) {
