...
public interface Function {
     ...
     */
    @SuppressWarnings( "unchecked" )
    public static abstract class ListFunction<T> extends BaseFunction<T> {

        protected abstract Optional<Object> applyList( final List<Object> argList );

        protected Optional<T> applySingle( final Object arg ) {
            return Optional.empty();
        }
    }
    ...
    public static abstract class ArgDrivenFunction<S, R> implements Function {
        ...
        protected final Class<S> specialArgType;

        protected ArgDrivenFunction() {
            /**
        ...
        protected Optional<S> getSpecialArg(Object[] args) {
    ...
    public static abstract class ArgDrivenSingleFunction<S, R> extends ArgDrivenFunction<S, R> {
        ...
        protected Optional<Object> applyList( S specialArg, List<Object> input ) {
            List<Object> ret = new ArrayList<>( input.size() );
            for(Object o: input) {
     ...
     */
    @SuppressWarnings( "unchecked" )
    public static abstract class ArgDrivenListFunction<S, R> extends ArgDrivenFunction<S, R> {

        protected abstract Optional<Object> applyList( S specialArg, List<Object> args );

        protected Optional<R> applySingle( S specialArg, Object arg ) {
            return Optional.empty();
        }
    }
