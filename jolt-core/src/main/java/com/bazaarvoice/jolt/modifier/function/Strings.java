...
public class Strings {
    ...
    public static final class concat extends Function.ListFunction<String> {
        @Override
    ...
    public static final class join extends Function.ArgDrivenListFunction<String, String> {
